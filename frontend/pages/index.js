...
<p class="mb-3 font-normal text-gray-700 dark:text-gray-400">ผู้แจ้งซ่อมสามารถแจ้งผ่านระบบออนไลน์ และสามารถตรวจสอบสถานะการแจ้งซ่อม ว่างานที่แจ้งอยู่ในสถานะใด เช่น แจ้งซ่อม/ รอตรวจสอบ / ดำเนินการ / ส่งซ่อม เป็นต้น</p>
<a href="/repair" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
แจ้งซ่อม
...
<p class="mb-3 font-normal text-gray-700 dark:text-gray-400">ฝ่ายช่างสามารถตรวจสอบประวัติการซ่อมของอุปกรณ์ เพื่อความสะดวกในการวิเคราะห์ปัญหาของอุปกรณ์ที่ผ่านมา</p>
